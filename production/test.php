...
<!-- ____________________________________________________________________________________________________________________________________________________________________________________________________ -->
                            ...
                            <select style="width:15%;" id="innotech1_user" class="form-select mt-1" aria-label="Default select example" autocomplete="on">
                                    ...
                                    $message = "SELECT name_operator FROM innotech1 WHERE name_operator <> '' GROUP BY name_operator ORDER BY id DESC LIMIT 1";
...
<!-- ____________________________________________________________________________________________________________________________________________________________________________________________________ -->
                            ...
                            <?php
                                    require($_SERVER['DOCUMENT_ROOT'].'/Engels/connect_db.php');
                                    $message = "SELECT name_operator FROM innotech2 WHERE name_operator <> '' GROUP BY name_operator ORDER BY id DESC LIMIT 1";
                                    $link->set_charset("utf8");
                                    $result = mysqli_query($link, $message);
...
<!-- ____________________________________________________________________________________________________________________________________________________________________________________________________ -->
                            ...
                            <?php
                                    require($_SERVER['DOCUMENT_ROOT'].'/Engels/connect_db.php');
                                    $message = "SELECT name_operator FROM innotech3 WHERE name_operator <> '' GROUP BY name_operator ORDER BY id DESC LIMIT 1";
                                    $link->set_charset("utf8");
                                    $result = mysqli_query($link, $message);
...
<!-- ____________________________________________________________________________________________________________________________________________________________________________________________________ -->
                            ...
                            <?php
                                    require($_SERVER['DOCUMENT_ROOT'].'/Engels/connect_db.php');
                                    $message = "SELECT name_operator FROM uva4 WHERE name_operator <> '' GROUP BY name_operator ORDER BY id DESC LIMIT 1";
                                    $link->set_charset("utf8");
                                    $result = mysqli_query($link, $message);
...
<!-- ____________________________________________________________________________________________________________________________________________________________________________________________________ -->
                            ...
                            <?php
                                    require($_SERVER['DOCUMENT_ROOT'].'/Engels/connect_db.php');
                                    $message = "SELECT name_operator FROM uva5 WHERE name_operator <> '' GROUP BY name_operator ORDER BY id DESC LIMIT 1";
                                    $link->set_charset("utf8");
                                    $result = mysqli_query($link, $message);
...
<!-- ____________________________________________________________________________________________________________________________________________________________________________________________________ -->
                            ...
                            <?php
                                    require($_SERVER['DOCUMENT_ROOT'].'/Engels/connect_db.php');
                                    $message = "SELECT name_operator FROM acma WHERE name_operator <> '' GROUP BY name_operator ORDER BY id DESC LIMIT 1";
                                    $link->set_charset("utf8");
                                    $result = mysqli_query($link, $message);
...
<!-- ____________________________________________________________________________________________________________________________________________________________________________________________________ -->
                            ...
                            <?php
                                    require($_SERVER['DOCUMENT_ROOT'].'/Engels/connect_db.php');
                                    $message = "SELECT name_operator FROM shrink WHERE name_operator <> '' GROUP BY name_operator ORDER BY id DESC LIMIT 1";
                                    $link->set_charset("utf8");
                                    $result = mysqli_query($link, $message);
...
<!-- ____________________________________________________________________________________________________________________________________________________________________________________________________ -->
                            ...
                            <?php
                                    require($_SERVER['DOCUMENT_ROOT'].'/Engels/connect_db.php');
                                    $message = "SELECT name_operator FROM pallet WHERE name_operator <> '' GROUP BY name_operator ORDER BY id DESC LIMIT 1";
                                    $link->set_charset("utf8");
                                    $result = mysqli_query($link, $message);
...
<!-- ____________________________________________________________________________________________________________________________________________________________________________________________________ -->
                            ...
                            <?php
                                    require($_SERVER['DOCUMENT_ROOT'].'/Engels/connect_db.php');
                                    $message = "SELECT name_operator FROM bunker WHERE name_operator <> '' GROUP BY name_operator ORDER BY id DESC LIMIT 1";
                                    $link->set_charset("utf8");
                                    $result = mysqli_query($link, $message);
...
<!-- ____________________________________________________________________________________________________________________________________________________________________________________________________ -->
                            ...
                            <?php
                                    require($_SERVER['DOCUMENT_ROOT'].'/Engels/connect_db.php');
                                    $message = "SELECT name_operator FROM sushka WHERE name_operator <> '' GROUP BY name_operator ORDER BY id DESC LIMIT 1";
                                    $link->set_charset("utf8");
                                    $result = mysqli_query($link, $message);
...
<!-- ____________________________________________________________________________________________________________________________________________________________________________________________________ -->
                            ...
                            <?php
                                    require($_SERVER['DOCUMENT_ROOT'].'/Engels/connect_db.php');
                                    $message = "SELECT name_operator FROM bashnya WHERE name_operator <> '' GROUP BY name_operator ORDER BY id DESC LIMIT 1";
                                    $link->set_charset("utf8");
                                    $result = mysqli_query($link, $message);
...
<!-- ____________________________________________________________________________________________________________________________________________________________________________________________________ -->
                            ...
                            <?php
                                    require($_SERVER['DOCUMENT_ROOT'].'/Engels/connect_db.php');
                                    $message = "SELECT name_operator FROM gazgen WHERE name_operator <> '' GROUP BY name_operator ORDER BY id DESC LIMIT 1";
                                    $link->set_charset("utf8");
                                    $result = mysqli_query($link, $message);
...
<!-- ____________________________________________________________________________________________________________________________________________________________________________________________________ -->
                            ...
                            <?php
                                    require($_SERVER['DOCUMENT_ROOT'].'/Engels/connect_db.php');
                                    $message = "SELECT name_operator FROM prigotovlenie WHERE name_operator <> '' GROUP BY name_operator ORDER BY id DESC LIMIT 1";
                                    $link->set_charset("utf8");
                                    $result = mysqli_query($link, $message);
...
<!-- ____________________________________________________________________________________________________________________________________________________________________________________________________ -->
                            ...
                            <?php
                                    require($_SERVER['DOCUMENT_ROOT'].'/Engels/connect_db.php');
                                    $message = "SELECT name_operator FROM postdobavki WHERE name_operator <> '' GROUP BY name_operator ORDER BY id DESC LIMIT 1";
                                    $link->set_charset("utf8");
                                    $result = mysqli_query($link, $message);
