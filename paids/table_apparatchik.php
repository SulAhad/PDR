        ...
        <table class="table-hover table table-sm table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="col-1">Вторичная вода</th>
            ...
            <tbody>
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($result))
                    {
                        ...
                        echo"<td><input id='quality4_$name' type='number' class='border-0 form-control form-control-sm' value='$row[quality4]'></input></td>";
...
<script>
    ...
    {$(".update_<?php echo$name ?>").click(function() {
        ...
        var quality4 = $(this).closest("tr").find("#quality4_<?php echo$name ?>").val();
        $.ajax(
            {
                type: 'POST',
                dataType: 'html',
                url: '/Engels/paids/update_apparatchik.php',
                data: ({
                    avtomat:avtomat,
                    date:date,
                    team:team,
