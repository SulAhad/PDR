            ...
            <div class="row card shadow-sm">
                ...
                <div class="col-md-12">
                    <fieldset class="form-group border m-2 p-3 card shadow-sm bg-light">
                        ...
                        <select id="selectId">
                        <div class="table-responsive" id="table_stat_2023">
                    ...
                    <script>
                        $(document).ready(function(){
                            ...
                            $('#table_stat_2023').hide();
                            
                            // Обработчик события изменения значения в селекте
                            $('#selectId').change(function(){
                                // Проверяем выбранное значение
                                if($(this).val() === 'show'){
                                    // Если выбрано "show", показываем таблицу
                                    $('#table_stat_2023').show();
                                } else {
                                    // Если выбрано что-то другое, скрываем таблицу
                                    $('#table_stat_2023').hide();
                                }
                            });
                        });
                ...
                <div class="col-md-12">
                    <fieldset class="form-group border card shadow-sm bg-light">
                        <div class="table-responsive">
                            ...
                            <button class="btn btn-primary btn-sm" id="loadMoreButton">показать еще..</button>
                            <script>
                                $(document).ready(function() {
                                    var offset = 25;
